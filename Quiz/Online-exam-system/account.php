...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Bem Vindo,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Sair</button></a></span>';
}?>
</div>
</div></div>
<div class="bg">
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    <!-- A marca e a alternância são agrupadas para uma melhor exibição em dispositivos celular -->
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="account.php?q=1"><b>PÁGINA - ALUNO</b></a>
    </div>

    <!--Colete os links de navegação, formulários e outro conteúdo para alternar...-->
    ...
    <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li>
      ...
      </div><!-- Fechamento do.navbar-collapse -->
  </div><!-- Fechamento do container-fluid -->
</nav><!--Fechamento do menu de navegação-->
...
<tr style="color:black"><td><b>S.N.</b></td><td><b>Tópico</b></td><td><b>Total de Questões</b></td><td><b>Alternativas</b></td><td><b>Acertos</b></td><td><b>Erradas</b></td><td><b>limite de Tempo</b></td><td></td><td></td></tr>';
$c=1;
...
echo '<div class="panel"<a title="Voltar" href="update.php?q1=2"><b><span class="glyphicon glyphicon-level-up" aria-hidden="true"></span></b></a><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>'.$title.'</b></h1>';
...
echo '<tr style="color:#66CCFF"><td>Total de Questões</td><td>'.$qa.'</td></tr>
      <tr style="color:#99cc32"><td>Questões acertadas&nbsp;<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></td><td>'.$r.'</td></tr> 
    <tr style="color:red"><td>Questões erradas&nbsp;<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></td><td>'.$w.'</td></tr>
...
{
$s=$row['score'];
echo '<tr style="color:#990000"><td>Sua pontuação total&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
}
echo '</table></div>';
...
<tr style="color:black"><td><b>S.N.</b></td><td><b>Quiz</b></td><td><b>Questões Resolvidas</b></td><td><b>Certas</b></td><td><b>Erradas<b></td><td><b>Pontuação</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
echo  '<div class="panel title">
<table class="table table-striped title1" >
<tr style="color:black"><td><b>Posição</b></td><td><b>Nome</b></td><td><b>Gênero</b></td><td><b>Escola</b></td><td><b>Pontuação</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
