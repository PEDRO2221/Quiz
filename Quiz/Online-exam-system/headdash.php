  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="headdash.php?q=0">Início<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="headdash.php?q=1">Usuário</a></li>
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="headdash.php?q=4">Adicionar Admin</a></li>
            <li><a href="headdash.php?q=5">Remover Admin</a></li>
          </ul>
        </li>
      </ul> 
          </div><!-- /.navbar-collapse -->
